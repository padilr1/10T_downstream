...
imageList <- list.files("~/Documents/10T_downstream/pushed_images/RNAseq/QKO_QuiKO/gene_expression/QKO_QuiKO/log2FoldChange", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

### FPKM 
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/RNAseq/QKO_QuiKO/gene_expression/QKO_QuiKO/FPKM", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```
...
<ul>
  ...
  <li>Then, these filtered peaks were extended 20000 bp upstream and downstream. The resulting peaks can be downloaded below. </li>
...
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
xfun::embed_file(path = "~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/filt_peaks_with_enh.bed")
```
...
### log2FoldChange {.tabset}

#### 20000 extend
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/log2FoldChange/20000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

#### 50000 extend
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/log2FoldChange/50000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

#### 100000 extend
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/log2FoldChange/100000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```
...
#### 20000
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/FPKM/20000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

#### 50000
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/FPKM/50000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

#### 100000
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/large_enhancer_regions/FPKM_9_to_12/FPKM/100000", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```
...
# Centered on ATAC-seq peaks within large K36me2 peaks (non-promoters) {.tabset}
<ul>
  <li>Filtered for ATAC-seq peaks found in both TKO and QKO overlapping the large K36me2 peaks.</li>
  <li>Any ATAC-seq peaks overlapping promoters were removed </li>
</ul>

## ATAC-seq
```{r,echo = FALSE,fig.show = "hold", out.width = "50%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/ATACseq_peaks_non_promoter/ATAC", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

## K4me1
```{r,echo = FALSE,fig.show = "hold", out.width = "50%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/ATACseq_peaks_non_promoter/K4me1", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

# Centered on ATAC-seq peaks within large K36me2 peaks (promoters) {.tabset}

## ATAC-seq
```{r,echo = FALSE,fig.show = "hold", out.width = "50%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/ATACseq_peaks_promoter/ATAC", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

## K4me1
```{r,echo = FALSE,fig.show = "hold", out.width = "50%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/ATACseq_peaks_promoter/K4me1", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```


# Promoter/enhancer ratios {.tabset}
<ul>
  <li>Filtered Fantom and Ensembl enhancers found within TKO K36me2 peaks. Ran featureCounts on K27ac bam files for these enhancers.</li>
  <li>Took promoters defined as 1000 bp upstream and 500 bp downstream. Ran featureCounts on K27ac bam files for these promoters.</li>
  <li>For each sample, took the sum of K27ac for enhancers, divided by the sum of enhancer lengths, and finally normalized by library depth (CPM). This process was repeat for each sample for promoters. Afterwards, the ratio of promoter to enhancer was calculated. </li>
  <li>Expectedly, there is greater signal at promoters compared to enhancers </li>
  <li>Upon losing K36me2, however, (TKO -> QKO) enhancers also lose K27ac, with the promoter/enhancer K27ac ratio increasing in the QKO compared to TKO </li>
</ul>

## K27ac
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/K27ac/enhancer_promoter_ratios", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```

## ATAC-seq
```{r,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
imageList <- list.files("~/Documents/10T_downstream/pushed_images/focal_K36me2/ATACseq_promoter_enhancer_ratio", pattern= "*.png", full.names=T)
include_graphics(imageList,dpi = 600)
```